...
img1 = cv2.imread(r"E:\cvproject\base_1_resize.jpeg")  # query Image
img2 = cv2.imread(r"E:\cvproject\mag5_resize.jpeg") # train Image
...
img_segment=cv2.addWeighted(masked_img_object, 0.8, masked_img_background, 0.2,0)
